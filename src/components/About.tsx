...
const skills = [
  ...
  { name: 'BLoC / Cubit', icon: Gear },
  { name: 'GetX', icon: Lightning },
  { name: 'Clean Architecture', icon: Stack },
  { name: 'Firebase', icon: Cloud },
  { name: 'REST APIs', icon: Plugs },
  { name: 'SQLite / Hive', icon: Database },
  { name: 'Security', icon: ShieldCheck },
  { name: 'NFC / QR', icon: QrCode },
  { name: 'Google Maps', icon: MapPin },
  { name: 'Testing', icon: TestTube },
  { name: 'CI/CD', icon: GitBranch },
  { name: 'Figma', icon: PenNib },
];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div ref={contentRef} className="space-y-6">
            <p className="text-lg text-muted-foreground leading-relaxed">
              Software Engineer with <span className="text-primary font-semibold">+4 years</span> of experience designing, building, and shipping high-performance, cross-platform 
applications for iOS and Android, including <span className="text-secondary font-semibold">+5 production apps</span> published to the App Store and Google Play.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed">
Specialized in Fintech and large-scale consumer products, Clean Architecture, MVVM, BLoC/GetX, CI/CD, APIs, and testing; delivers secure, scalable, high-performance apps in Agile teams.            </p>
        ...
        <div ref={skillsRef} className="mt-16">
          ...
          <div className="relative flex items-center gap-2 sm:gap-4">
            ...
            >
              <div className={`flex gap-3 sm:gap-4 ${!isPaused ? 'animate-marquee' : ''}`}>
